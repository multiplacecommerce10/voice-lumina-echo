...
const membershipUrl = "https://voice-lumina-echo.lovable.app/membership";
...
const issues = auditConfirmationEmail(confirmation, to);
console.log("audit issues:", JSON.stringify(issues));
...
const payload = {
  ...
  form_answers: {
    ...
    experience: "8 years singing in choirs and small jazz ensembles",
    main_goal: "Expand vocal range and gain confidence for solo performance",
    styles: ["Jazz", "MPB", "Sacred repertoire"],
    country: "Brazil",
    city: "Porto Alegre",
...
const url = process.env.TASKADE_WEBHOOK_URL!;
